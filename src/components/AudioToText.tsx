...
export default function AudioToText() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setResponse("This is a simulated transcription from Gemini API. The actual integration will be implemented when you add your API key.");
    setIsLoading(false);
  };
  ...
  return (
    <div className="bg-gray-800 rounded-lg shadow-xl p-6">
          ...
          <div className="flex items-center justify-center w-full">
            <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-600 border-dashed rounded-lg cursor-pointer bg-gray-700 hover:bg-gray-600 transition-colors">
              <div className="flex flex-col items-center justify-center pt-5 pb-6">
                {file ? (
                  <>
                    <Mic className="w-12 h-12 mb-3 text-purple-500" />
      ...
      {response && (
        <div className="mt-6">
          <h2 className="text-lg font-medium text-gray-200 mb-2">Transcription</h2>
